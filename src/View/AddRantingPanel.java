...
public class AddRantingPanel extends JPanel {
    ...
    public AddRantingPanel() {
        ...
        this.addRantingButton = new JButton("Ajouter");
        ...
        //button
        this.carSearchButton = new JButton("rechercher");
        ...
        //button
        this.clientSearchButton = new JButton("rechercher");
        ...
        topPanel.setBorder( BorderFactory.createTitledBorder(BorderFactory.createLineBorder(new Color(66, 134, 244)),"Ajouter nouvelle location"));
       ((javax.swing.border.TitledBorder) topPanel.getBorder()).setTitleFont(ff);
        ...
        rightPanel.setBorder( BorderFactory.createTitledBorder(BorderFactory.createLineBorder(new Color(66, 134, 244)),"Rechercher client"));
